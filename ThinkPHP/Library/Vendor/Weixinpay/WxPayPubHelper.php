...
class Common_util_pub
{
	...
	function postXmlSSLCurl($xml,$url,$second=30)
	{
		...
		//WxPayConf_pub::SSLCERT_PATH
		//$sslcert = __ROOT__.'/ThinkPHP/Library/Vendor/Weixinpay/cacert/apiclient_cert.pem';
		$sslcert = 'http://www.chemom.com/cert/apiclient_cert.pem';
		curl_setopt($ch,CURLOPT_SSLCERT, dirname(__FILE__) . '/cacert/apiclient_cert.pem');
		//默认格式为PEM，可以注释
		curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
		//WxPayConf_pub::SSLKEY_PATH
		//$sslkey = __ROOT__.'/ThinkPHP/Library/Vendor/Weixinpay/cacert/apiclient_key.pem';
		$sslkey = 'http://www.chemom.com/cert/apiclient_key.pem';
